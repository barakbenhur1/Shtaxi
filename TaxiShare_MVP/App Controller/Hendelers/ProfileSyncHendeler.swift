...
class ProfileSyncHendeler: ObservableObject {
    ...
    @Published private var router = Router.shared
    @Published private var manager = CoreDataManager.shared
    @Published private var vm = ViewModelProvider.shared.onboardingVM
